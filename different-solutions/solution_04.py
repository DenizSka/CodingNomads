...
for tup in list(unsorted_list): # this one does not matter since it used for only looping through each item kind of like a while loop
    # why do we define these inside the loop.
